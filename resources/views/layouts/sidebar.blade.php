    ...
    <ul class="nav nav-pills nav-flush flex-column mb-auto text-center ms-1">
        ...
        @can('inManager')
            ...
            <li class="nav-item mb-1">
                ...
                <a href="{{ route('manager.stats') }}"
                    class="nav-link rounded-3
            @if (Route::currentRouteName() == 'manager.liste_employes') active @endif
            py-3 border-bottom"
        ...
        @canany(['isManager', 'isReferent'])
            <li class="nav-item mb-1">
                ...
                <a href="{{ route('home_manager') }}"
                    class="nav-link rounded-3
            @if (Route::currentRouteName() == 'home_manager') active @endif
            py-3 border-bottom"
                    aria-current="page" title="Gérer les congés" data-bs-toggle="tooltip" data-bs-placement="right">
            ...
            <li class="nav-item mb-1">
                ...
                <a href="{{ route('manager.liste_employes') }}"
                    class="nav-link rounded-3
            @if (Route::currentRouteName() == 'manager.liste_employes') active @endif
            py-3 border-bottom"
                    aria-current="page" title="Gérer l'équipe" data-bs-toggle="tooltip" data-bs-placement="right">
        ...
        @can('isReferent')
            <li class="nav-item mb-1">
                ...
                <a href="{{ route('home_referent') }}"
                    class="nav-link rounded-3
        @if (Route::currentRouteName() == 'home_referent') active @endif
        py-3 border-bottom"
            ...
            <li class="nav-item mb-1">
                <a href="{{ route('edit_work_times') }}"
                    class=" rounded-3
        @if (Route::currentRouteName() == 'edit_work_times') active @endif
        nav-link py-3 border-bottom"
                    title="Seetings" data-bs-toggle="tooltip" data-bs-placement="right">
