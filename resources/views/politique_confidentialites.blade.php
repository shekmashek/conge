...
<div class="container-fluid">
        ...
        <div class="container-fluid">
            <div class="left_menu ms-2">
                <a style=" text-decoration: none;" href="{{ route('accueil_perso') }}">
                    ...
                    <img class="img-fluid" src="{{ asset('img/logos_all/iconConge.webp') }}" width="40px" height="40px"> Conge.mg</p>
                </a>
            </div>
    ...
    <div class="row col-12" style="margin-top: 90px;">
        ...
        <div class="col-8" >
            ...
            <h1 class="mt-5">Politique de confidentialité de la plateforme <span id="politique" >Conge.mg</span></h1>
            <div>
