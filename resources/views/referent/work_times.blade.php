                    ...
                    <div class = "row">
                        <div class = "container-fluid">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    <input type="time" class="form-control input-sm" id="debut_journee" name="debut"  required>
                                </div>
                                <label for="date_fin" class="col-form-label col-sm-2">heure de fin</label>
                                <div class="col-sm-3">
                                    <input type="time" class="form-control input-sm" id="fin_journee" name="fin"  required>
                                </div>
                                <div class="col-sm-2">
                    ...
                    <div class = "row">
                        <div class = "container-fluid">
                            <div class="form-group row">
                                ...
                                <label for="date_debut" class="col-form-label col-sm-2">heure de début</label>
                                <div class="col-sm-3">
                                    <input type="time" class="form-control input-sm" id="debut" name="debut_nuit" placeholder="Date de début" required>
                                </div>
                                <label for="date_fin" class="col-form-label col-sm-2">heure de fin</label>
                                <div class="col-sm-3">
                                    <input type="time" class="form-control input-sm" id="fin" name="fin_nuit"  placeholder="Date de fin" required>
                                </div>
                                <div class="col-sm-2">
                                    <button id="btnDef" class="btn btn-primary" name="set_time" title="set_time">definir</button>
                                </div>
