...
Route::get('/jours_conge_paye_employe/{year}/{month}/{employe_id}', [CongeApiController::class, 'totalCongePayeEmploye']);
Route::get('/jours_conge_nonpaye_employe/{year}/{month}/{employe_id}', [CongeApiController::class, 'totalCongeNonPayeEmploye']);
