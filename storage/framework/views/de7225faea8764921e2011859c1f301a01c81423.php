  ...
  <div class="comtainer mt-5">
    ...
    <table id="liste_en_attente" class="table table-striped" style="width:100%">
        ...
        <tbody>
            <?php $__empty_1 = true; $__currentLoopData = $conges_en_attente; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $conge): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <tr>
                <td class="align-middle text-center"><?php echo e($conge->employe->nom_emp.' '.$conge->employe->prenom_emp); ?></td>
                <td class="align-middle text-center"><?php echo e($conge->type_conge->type_conge); ?></td>
                <td class="align-middle text-center"><?php echo e(date('d M Y - H:i', strtotime($conge->debut))); ?></td>
                <td class="align-middle text-center"><?php echo e(date('d M Y - H:i',strtotime($conge->fin))); ?></td>
                <td class="align-middle text-center"><?php echo e($conge->j_utilise); ?></td>
                <td class="align-middle text-center"><?php echo e($conge->motif); ?></td>
                <td class="align-middle text-center">
                    <?php if($conge->etat_conge->id == 3): ?>
...
<script>
    ...
    var events = <?php echo json_encode($calendar, JSON_HEX_TAG); ?>;
...
<?php $__env->stopPush(); ?>
<?php /**PATH E:\Stevy\Etudes\Projets\Stage_upskill\Laravel\conge\resources\views/rh/liste_en_attente.blade.php ENDPATH**/ ?>