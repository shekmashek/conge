...
<ul class="nav nav-tabs mb-3 border-0" id="ex1" role="tablist">
    ...
    <?php endif; ?>
        ...
        <li class="nav-item mx-2 position-absolute end-0" role="presentation">
            <a href="<?php echo e(route('calendrier_conge')); ?> " class="d-flex nav-link align-items-center">
  ...
  <div class="tab-content" id="ex1-content">
    <div
      ...
      aria-labelledby="ex1-tab-1">
        ...
        <?php echo $__env->make('referent.liste_conge', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

    </div>

    <div class="tab-pane fade" id="tab_liste_attente" role="tabpanel" aria-labelledby="tab_liste_attente">
        <?php echo $__env->make('referent.liste_conge_en_attente', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Stevy\Etudes\Projets\Stage_upskill\Laravel\conge\resources\views/referent/home_referent.blade.php ENDPATH**/ ?>