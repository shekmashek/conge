...
<div class="modal fade " id="refuser_conge">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
          ...
          <form action="<?php echo e(route('conge.refuser_demande')); ?>" method="POST">
...
<script>
    ...
    $('#refuser_conge').submit(function(e){
        ...
        e.preventDefault();
        var url = "<?php echo e(route('conge.refuser_demande')); ?>";
    ...
    $(document).ready(function () {
        ...
        var table = $('#liste_en_attente').DataTable({
            ...
            ajax: {
                url: "<?php echo e(route('home_referent')); ?>",
                data: function (d) {
...
<?php $__env->stopPush(); ?>
<?php /**PATH E:\Stevy\Etudes\Projets\Stage_upskill\Laravel\conge\resources\views/referent/liste_conge_en_attente.blade.php ENDPATH**/ ?>