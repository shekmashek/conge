...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo e(asset('img/logos_all/iconConge.webp')); ?>" type="image/x-icon">
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/index_accueil.css')); ?>">
                ...
                <div class="left_menu ms-2">
                    <a href="<?php echo e(route('accueil_perso')); ?>">
                        <p class="titre_text m-0 p-0">
                            <img class="img-fluid" src="<?php echo e(asset('img/logos_all/iconConge.webp')); ?>" alt="logo">
                            Conge.mg
                        </p>
                    </a>
                </div>
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item ms-2">
                            <a class="nav-link links " href="<?php echo e(url('tarifs')); ?>" target="_blank" rel="noopener noreferrer">Tarifs</a>
                        </li>
                        <li class="nav-item ms-2">
                            <a class="nav-link links" href="#apropos">À propos</a>
                        </li>
                        <li class="nav-item ms-2">
                            <a class="nav-link links" href="<?php echo e(url('contact')); ?>" target="_blank" rel="noopener noreferrer">Contactez-nous</a>
                        </li>
                    ...
                    <div class="menu_action">
                        <ul class="d-flex">
                            <li class="nav-item">
                                <a href="<?php echo e(route('sign-in')); ?>" class="btn_login me-2" role="button">Se connecter</a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('create-compte')); ?>" class="btn_creerCompte me-2"
                ...
                <div class="row h-100">
                    <div class="container p-0 g-0">
                        <div class="col-6 section1_text g-0 m-0">
                            ...
                            <a href="<?php echo e(route('sign-in')); ?>" role="button" class="commencer">Commencer</a>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div class="row">
                    <div class="container">
                        <div class="col-12 section2_img">
                            <img src="<?php echo e(asset('img/logos_all/iconConge.webp')); ?>" alt="logo" class="img-fluid">
                        </div>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-6 image">
                            <img src="<?php echo e(asset('images/background_images/18section3 - copie.webp')); ?>" alt="image1" class="img-fluid">
                        </div>
            ...
            <section class="section4">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-6 image">
                            <lottie-player src="<?php echo e(asset('lottie/security.json')); ?>" background="transparent"  speed="0.6"  style="width: 75%;" loop autoplay></lottie-player>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-6 image text-center">
                            <a href="<?php echo e(url('contact')); ?>" target="_blank" rel="noopener noreferrer" role="button" class="commencer">Nous contacter</a>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <div class="container-fluid">
                <div class="row d-flex flex-column">
                    <div class="d-flex mb-3">
                        ...
                        <div class="bordure"><a href="<?php echo e(url('info_legale')); ?>" target="_blank" rel="noopener noreferrer">Informations légales</a></div>
                        <div class="bordure"><a href="<?php echo e(url('contact')); ?>" target="_blank" rel="noopener noreferrer">Contactez-nous</a></div>
                        <div class="bordure"><a href="<?php echo e(url('politique_confidentialites')); ?>" target="_blank" rel="noopener noreferrer">Politique de
                                confidentialités</a></div>

                        <div class="bordure">
                            <a href="<?php echo e(route('condition_generale_de_vente')); ?>" target="_blank" rel="noopener noreferrer">
                                Condition
                                d'utilisation
                            </a>
                        </div>
                        <div class="bordure"> <a href="<?php echo e(url('tarifs')); ?>" target="_blank" rel="noopener noreferrer"> Tarifs</a></div>
...
<?php /**PATH E:\Stevy\Etudes\Projets\Stage_upskill\Laravel\conge\resources\views/index_accueil.blade.php ENDPATH**/ ?>