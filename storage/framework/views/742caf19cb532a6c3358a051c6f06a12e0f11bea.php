        ...
        <div class="row w-100 mt-3 justify-content-between">
            ...
            <ul class="nav nav-tabs mb-3 border-0" id="ex1" role="tablist">
                    ...
                    <li class="nav-item mx-auto underline_hover" role="presentation">
                        <a href="<?php echo e(route('home_RH')); ?> " class="nav-link d-flex align-items-center fs-4">
...
<script>
                ...
                var events = <?php echo json_encode($events, JSON_HEX_TAG); ?>;
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Stevy\Etudes\Projets\Stage_upskill\Laravel\conge\resources\views/rh/calendrier_conge.blade.php ENDPATH**/ ?>