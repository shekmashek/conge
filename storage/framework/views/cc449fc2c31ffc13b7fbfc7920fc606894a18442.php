...
<link rel="stylesheet" href="<?php echo e(asset('css/conge_employe/accueil.css')); ?>">
...
<div class="modal modal-conge" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            <!-- Début mainForm -->
            <form method="post" action="<?php echo e(route('insert_absence_employe')); ?>" id="mainForm">
                <?php echo csrf_field(); ?>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12">
                            <select class="form-select" aria-label="Default select example"
                                ...
                                <?php $__currentLoopData = $type_conges; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type_conge): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($type_conge['id']); ?>"><?php echo e($type_conge['type_conge']); ?>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8" id="datyapresselectiontype1">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input testee" type="radio" name="tpsdebut" id="debut1" value="08:00" <?php echo e(old('tpsdebut') == '08:00' ? 'checked' : ''); ?>>
                                <label class="form-check-label" for="debut1">Matin</label>
                            </div>

                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="tpsdebut" id="debut2" value="13:00" <?php echo e(old('tpsdebut') == '13:00' ? 'checked' : ''); ?>>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8" id="datyapresselectiontype2">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="tpsfin" id="fin1" value="12:00" <?php echo e(old('tpsfin') == '12:00' ? 'checked' : ''); ?>>
                                <label class="form-check-label" for="fin1">Matin</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="tpsfin" id="fin2" value="17:00" <?php echo e(old('tpsfin') == '17:00' ? 'checked' : ''); ?>>
...
<div class="modal fade " id="historique2" tabindex="-1" aria-labelledby="historique2" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg modal-fullscreen-sm-down">
      <div class="modal-content" style="min-height: 500px">
        <div class="modal-header">
            <h4>Historique des demandes de <span style="text-decoration: underline"><?php echo e($historiquesCongeEmp[0]->nom_emp.' '.$historiquesCongeEmp[0]->prenom_emp); ?></span></h4>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#mainForm').on('submit', function (e) {
            ...
            $.ajax({
                url: '<?php echo e(route('insert_absence_employe')); ?>',
                method: 'POST',
                data: {
                    //user_id: $('#user_id').val(),
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Stevy\Etudes\Projets\Stage_upskill\Laravel\conge\resources\views/conge_employe/home_conge_employe.blade.php ENDPATH**/ ?>