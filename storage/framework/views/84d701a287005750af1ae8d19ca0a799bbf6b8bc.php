  ...
  <div class="tab-content" id="ex1-content">
    <div
      ...
      aria-labelledby="ex1-tab-1">
        ...
        <?php echo $__env->make('manager.liste_conge', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

    </div>

    <div class="tab-pane fade" id="tab_liste_attente" role="tabpanel" aria-labelledby="tab_liste_attente">
        <?php echo $__env->make('manager.liste_en_attente', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Stevy\Etudes\Projets\Stage_upskill\Laravel\conge\resources\views/manager/home_manager.blade.php ENDPATH**/ ?>